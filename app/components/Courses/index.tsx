...
const postData: DataType[] = [
    {
        heading: 'Diploma in Nursing',
        name: "Matha Nursing Course",
        imgSrc: '/assets/courses/nursing.jpg',
        students: 150,
        classes: 12,
        price: 20,
        rating: 4.7,
    },
    {
        ...
        name: "Matha Nursing Course",
        imgSrc: '/assets/courses/labtechnician.jpg',
        students: 130,
        classes: 12,
        price: 20,
        rating: 4.7,
    ...
    {
        heading: 'X-Ray Technician',
        name: "Matha Nursing Course",
        imgSrc: '/assets/courses/xray.jpg',
        students: 120,
        classes: 12,
        price: 20,
        rating: 4.7,
            ...
            <div id="courses">
                <div className='mx-auto max-w-7xl sm:py-8 px-4 lg:px-8 '>
                    ...
                    <div className="sm:flex justify-between items-center">
                        <h3 className="text-midnightblue text-4xl lg:text-55xl font-semibold mb-5 sm:mb-0">Programmes Offered.</h3>
                                ...
                                <div className='bg-white m-3 px-3 pt-3 pb-12 my-20 shadow-courses rounded-2xl'>
                                    ...
                                    <div className="px-3">
                                        ...
                                        <div className="flex justify-between items-center py-6">
                                            ...
                                            <div>
                                                <h3 className="text-3xl font-medium">INR {items.price}</h3>
                                            </div>
                                        </div>
